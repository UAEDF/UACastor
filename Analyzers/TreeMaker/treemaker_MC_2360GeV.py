...
duplicateCheckMode = cms.untracked.string("checkEachRealDataFile"),
    ...
    fileNames = cms.untracked.vstring(
        ...
        #'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/hvanhaev//PYTHIA6_MinBias_2360GeV_redigi_1.root',
        #'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/hvanhaev//PYTHIA6_MinBias_2360GeV_redigi_2.root',
        #'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/hvanhaev//PYTHIA6_MinBias_2360GeV_redigi_3.root',
        #'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/hvanhaev//PYTHIA6_MinBias_2360GeV_redigi_4.root',
        # 'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/ochesanu/PYTHIA6_MinBias_2360GeV_uncalibrated_1.root',
         'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/ochesanu/PYTHIA6_MinBias_2360GeV_redigi_1.root',
    )
)
...
process.treemaker = cms.EDAnalyzer('TreeMaker',
      OutputFileName = cms.string("TreeMaker_MCApril8_MinBias2360GeV.root"),
      CaloJetCorrector = cms.string('L2L3JetCorrectorAK5Calo'),
      PFJetCorrector = cms.string('L2L3JetCorrectorAK5PF'),
      HLTriggerResults = cms.InputTag( 'TriggerResults','','HLT' ),
      CaloJets = cms.InputTag('ak5CaloJets', '', 'RECO'),
...
process.TFileService = cms.Service("TFileService",
   fileName = cms.string("CentralJetFilters_MCApril8_MinBias2360GeV.root")
)
