...
Cascade2Parameters = cms.PSet(
    ...
    CascadeSettings = cms.vstring('KE = 2212 ! flavour code of beam1',
                                  ...
                                  'IPRO = 10 ! process number (IPRO = 2 J/psi g, IPRO = 10 q qbar,IPRO = 11 Q Qbar)',
                                  ...
                                  'IRPA = 1 ! switch to select QCD process g* g* -> q qbar via IRPA = 1',
                                  'IRPB = 1 ! switch to select QCD process g* g -> g g via IRPB = 1',
                                  'IRPC = 1 ! switch to select QCD process g* q -> g q via IRPC = 1',
